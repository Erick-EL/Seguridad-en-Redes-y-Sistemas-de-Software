...
`ssh -p 51484 ctf-player@atlas.picoctf.net`
...
```
ssh -p 51484 ctf-player@atlas.picoctf.net
Son69-academy@webshell:~$ ssh -p 51484 ctf-player@atlas.picoctf.net
...
Higher! Try again.
Enter your guess: 558
Higher! Try again.
Enter your guess: 559
Congratulations! You guessed the correct number: 559
Here's your flag: picoCTF{g00d_gu355_3af33d18}
Connection to atlas.picoctf.net closed.
```
## Notas adicionales 
* se trata de habilidad hasta obtener el numero ganador 
## Referencias
